    ...
    if(isset($_POST['btn_simpan']) && $_POST['btn_simpan'] == 'simpan_profil'){
        ...
        if($_FILES['gambar']['name'] !=''){
            ...
            if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                if($ukuran < 3044070){
                        move_uploaded_file($file_tmp, '../apload/' . $ubah_nama);

                     $sql_update_profil = "UPDATE pendaftar set foto = '$ubah_nama'
                ...
                echo " ektensi tidak diperbolehkan"; 
                die;
            }
        ...
        $sql_update_profil = "UPDATE pendaftar set nama='$nama', tmpt_lahir='$tempat_lahir',
         tgl_lahir='$tanggal_lahir', jenis_kelamin='$jenis_kelamin', agama='$agama',
          alamat='$alamat', email='$email', telephone='$telephone' where id='$id_pendaftar'";
